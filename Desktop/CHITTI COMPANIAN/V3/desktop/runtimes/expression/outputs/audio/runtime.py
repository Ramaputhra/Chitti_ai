...
class AudioRuntime:
    ...
    Specifically handles short SFX (success.wav, error.wav, click.wav).
    Dynamic TTS is handled by VoiceRuntime.
    ...
    def _play_sound(self, sound_id: str):
        ...
        logger.info(f"[Audio Runtime] Playing short SFX: {sound_id}")
