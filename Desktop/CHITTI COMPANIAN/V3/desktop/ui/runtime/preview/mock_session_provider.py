...
class MockSessionProvider:
    ...
    def get_mock_sessions() -> List[UISession]:
        return [
            UISession("sess_media_1", "Media", {"title": "Cyberpunk Synthwave", "artist": "Vizzu Beats", "playing": True, "progress": 0.45}),
            ...
            UISession("sess_download_1", "Download", {"filename": "vizzu_v2_core.zip", "progress": 0.82, "eta": "5s"}),
            UISession("sess_upload_1", "Upload", {"filename": "telemetry_logs.tar.gz", "progress": 0.60, "eta": "12s"}),
            UISession("sess_presentation_1", "Presentation", {"name": "Vizzu Architecture Overview", "current_slide": 4, "total_slides": 12}),
            UISession("sess_vision_1", "Vision", {"camera_preview": "active", "ocr_status": "READY", "detection_count": 2}),
            UISession("sess_browser_1", "Browser", {"active_tab": "GitHub - Vizzu Companion", "url": "https://github.com/Ramaputhra"}),
