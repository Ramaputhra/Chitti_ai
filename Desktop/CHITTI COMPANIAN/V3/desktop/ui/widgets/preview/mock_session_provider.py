...
class MockSessionProvider:
    ...
    def get_mock_sessions() -> List[WidgetSession]:
        return [
            WidgetSession("sess_media_1", "Media", "media_player", {"title": "Cyberpunk Synthwave", "artist": "Vizzu Beats", "playing": True, "provider": "Spotify", "progress": 0.45}),
            ...
            WidgetSession("sess_browser_1", "Browser", "browser_automation", {"active_tab": "GitHub - Vizzu Companion", "url": "https://github.com/Ramaputhra"}),
            WidgetSession("sess_navigation_1", "Navigation", "maps_assistant", {"destination": "Innovation Park", "eta": "14 mins", "distance": "5.2 km"}),
            WidgetSession("sess_presentation_1", "Presentation", "presentation_engine", {"name": "Vizzu Architecture Overview", "current_slide": 4, "total_slides": 12}),
            ...
            WidgetSession("sess_download_1", "Download", "download_manager", {"filename": "vizzu_v2_core.zip", "progress": 0.82, "eta": "5s"}),
