...
class TestDesktopIntentCapability(unittest.TestCase):
    def setUp(self):
    ...
    def test_end_to_end_capability_demonstration(self, mock_pipeline_builder):
        ...
        User "Open Downloads" -> ModernBERT -> IntentService -> Registry -> Execute -> Log
        """
        # Mock the HuggingFace pipeline to return exactly what ModernBERT would
