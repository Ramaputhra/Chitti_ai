...
class TestIntentProvider(unittest.TestCase):
    def setUp(self):
        ...
        manifest_data = {
            "component_id": "vizzu_intent_classifier",
    ...
    def test_end_to_end_capability_demonstration(self, mock_pipeline_builder):
        ...
        adapter = TextClassificationProvider("xlm-roberta-base", "vizzu_intent_classifier", self.tracker)
        self.comp_runtime.load_component("vizzu_intent_classifier", adapter)
        self.comp_runtime.warm_component("vizzu_intent_classifier")
    ...
    def test_confidence_rules_fallback(self, mock_pipeline_builder):
        ...
        adapter = TextClassificationProvider("mock", "vizzu_intent_classifier", self.tracker)
        self.comp_runtime.load_component("vizzu_intent_classifier", adapter)
        self.comp_runtime.warm_component("vizzu_intent_classifier")
