# Vizzu Platform Architecture v3.0

This document defines the frozen foundational architecture of the Vizzu Companion platform. The subsystems listed below have reached architectural maturity and stability.
...
12. **Presence Runtime**: Manages Vizzu's operational modes (Active, Quiet, Sleep) and embodiment visibility states decoupled from execution.
