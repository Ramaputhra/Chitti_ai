# Vizzu Desktop Companion Blueprint (Version 1.0)

This document defines **What Vizzu is.** It is the foundational vision for the project.

## 1. What Vizzu Is
Vizzu is a local-first, privacy-respecting, extensible Desktop AI Companion designed for Windows. It acts as an intelligent assistant that lives on the user's desktop, observing, remembering, and assisting with daily productivity without requiring constant manual invocation.
...
3. **Companion Presence**: A minimal system tray icon and visual overlay widget indicating states (Listening, Thinking, Speaking, Working) so the user always knows what Vizzu is doing.
...
## 3. What Vizzu Is Not
Vizzu is not a cloud service, not an abstract research framework, and not an autonomous web scraper. It does not replace the user; it works alongside them.
